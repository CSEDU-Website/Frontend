...
export default function AdminEventPage() {
  ...
  return (
    <motion.div
      className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 py-10"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    >
      <motion.h2
            ...
            return (
              ...
              >
                ...
                <div className="flex gap-4 items-center">
                  {event.image_url && event.image_url !== "string" ? (
                    <img
                      src={event.image_url}
                      alt={event.name}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 text-xs mt-1">
                      ...
                      {event.registration_link && event.registration_link !== "string" && (
                        <a
                      ...
                      {event.video_url && event.video_url !== "string" && (
                        <a
          ...
          <div className="bg-white rounded-lg p-8 w-full max-w-lg shadow-xl">
            ...
            <div className="space-y-3">
              ...
              <input
                className="w-full border rounded p-2"
                type="datetime-local"
                value={editEvent.registration_deadline?.slice(0, 16)}
                onChange={(e) =>
                  setEditEvent({
                    ...editEvent,
              ...
              <input
                ...
                onChange={(e) =>
                  setEditEvent({ ...editEvent, registration_link: e.target.value })
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setEditEvent({ ...editEvent, image_url: e.target.value })
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setEditEvent({ ...editEvent, video_url: e.target.value })
                }
