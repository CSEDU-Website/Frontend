...
function Login() {
  ...
  const defaultUsers = [
    { email: 'student@du.ac.bd', password: 'student123', role: 'student', fullname: 'Student User' },
    { email: 'teacher@du.ac.bd', password: 'teacher123', role: 'teacher', fullname: 'Teacher User' },
    { email: 'admin@du.ac.bd', password: 'admin123', role: 'admin', fullname: 'Admin User' },
    { email: 'a', password: 'pass', role: 'student', fullname: 'Test Student' } // Original test user
  ]
  ...
  const handleSubmit = (e) => {
    ...
    // Find user in our default users array
        ...
        <div className="w-full max-w-md p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-sm">
              Please log in to access your courses, grades, and resources
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-800/80 border border-red-500 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                required
              />
            </div>
            ...
            <div className="space-y-4">
              <div>
                <p className="text-slate-400 text-sm mb-3">or login with:</p>
